...
Đồ án môn học **Lập trình Hướng đối tượng (OOP)**. Đây là một hệ thống nền tảng Web được xây dựng nhằm giải quyết triệt để bài toán sắp xếp lịch gác thi, loại bỏ lỗi trùng lịch, và tự động hóa quy trình quản lý tài chính cho công tác khảo thí tại các trường Đại học.
